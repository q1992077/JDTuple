...
#define jd_unpack_c_overloadable(octype, func) __attribute__((overloadable)) octype tmp_tuple_unpack_c(id tuple, const char *key, void(^block)(octype)) { \
    if (!tuple) {\
...
jd_unpack_c_overloadable(int, intValue)
jd_unpack_c_overloadable(unsigned int, unsignedIntValue)
jd_unpack_c_overloadable(long, longValue)
jd_unpack_c_overloadable(unsigned long, unsignedLongValue)
jd_unpack_c_overloadable(long long, longLongValue)
jd_unpack_c_overloadable(unsigned long long, unsignedLongLongValue)
jd_unpack_c_overloadable(float, floatValue)
jd_unpack_c_overloadable(double, doubleValue)
jd_unpack_c_overloadable(short, shortValue)
jd_unpack_c_overloadable(unsigned short, unsignedShortValue)
jd_unpack_c_overloadable(_Bool, boolValue)
jd_unpack_c_overloadable(char, charValue)
jd_unpack_c_overloadable(unsigned char, unsignedCharValue)
jd_unpack_c_overloadable(CGPoint, CGPointValue)
jd_unpack_c_overloadable(CGRect, CGRectValue)
jd_unpack_c_overloadable(CGSize, CGSizeValue)
